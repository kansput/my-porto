...
export const Certificates = () => {
  ...
  return (
    <section id="certificates" className="py-24 px-4 max-w-7xl mx-auto border-b-8 border-black">
        ...
        {currentItems.map((cert, index) => (
          ...
          >
            ...
            <div className="px-2 pb-4">
              <h3 className="font-black text-xl uppercase leading-tight mb-1 group-hover:underline">{cert.title}</h3>
      ...
      {/* TERMINAL-STYLE NAVIGATION - FIX ERROR text-2xl */}
      <div className="mt-20 flex flex-col items-center gap-6">
        <div className="flex items-center gap-4 bg-white border-4 border-black p-2 shadow-hard">
          <button
          ...
          >
            {/* FIX: className digunakan untuk ukuran, bukan prop langsung */}
